...
TRANS = {
    'EN': {
        ...
        'gloss_mvrv': "MVRV Z-Score: Market Value vs Realized Value.\n\n🐣 **Beginner**: < 0 is 'Undervalued' (Buy Zone). > 3.5 is 'Overvalued' (Sell Zone).\n🧠 **Guru Wisdom**: *'Buy when there is blood in the streets.'* (Low MVRV)",
        'gloss_rsi': "RSI: Relative Strength Index.\n\n🐣 **Beginner**: < 30 means 'Oversold' (Cheap). > 70 means 'Overbought' (Expensive).\n🧠 **Guru Wisdom**: *'Be fearful when others are greedy.'* (High RSI)",
        'gloss_sharpe': "Sharpe Ratio: Risk-Adjusted Return.\n\n🐣 **Beginner**: Higher is better. > 1 means good returns for the risk taken.\n🧠 **Guru Wisdom**: *'Return without risk is just a dream... Sharpe measures the reality.'*",
        'gloss_crypash_score': "Crypash Score: 0-100 Quality Score.\n\n🐣 **Beginner**: Like a report card. > 70 is an 'A' Grade coin. Focus on Financials & Adoption.\n🧠 **Guru Wisdom**: *'Price is what you pay. Value is what you get.'*",
        'gloss_cycle': "Cycle Risk: Distance from Top.\n\n🐣 **Beginner**: < 20% means low risk (Bottom). > 80% means high risk (Top).\n🧠 **Guru Wisdom**: *'Bull markets are born on pessimism, grow on skepticism, and die on euphoria.'* - Sir John Templeton",
    ...
    'TH': {
        ...
        'gloss_mvrv': "MVRV Z-Score: ดัชนีวัดความถูกแพง\n\n🐣 **ฉบับมือใหม่**: \n- ค่าติดลบ (< 0) = **'ของถูก'** (Undervalued) เหมือนซื้อราคาทุน\n- ค่าสูง (> 3.5) = **'ของแพง'** (Overvalued) ระวังดอย\n\n🧠 **มุมมองเซียน**: *'จงกล้าเมื่อคนอื่นกลัว' (MVRV ต่ำ)*",
        'gloss_rsi': "RSI: ดัชนีโมเมนตัม (แรงส่งราคา)\n\n🐣 **ฉบับมือใหม่**: \n- < 30 = **ขายมากไป** (เตรียมเด้ง)\n- > 70 = **ซื้อมากไป** (เตรียมร่วง)\n\n🧠 **มุมมองเซียน**: *'เทรนด์คือเพื่อนของคุณ' (จนกว่าจะเปลี่ยนทิศ)*",
        'gloss_sharpe': "Sharpe Ratio: ความคุ้มค่าต่อความเสี่ยง\n\n🐣 **ฉบับมือใหม่**: ยิ่งสูงยิ่งดี (> 1 คือเก่ง)\n🧠 **มุมมองเซียน**: *'เสี่ยงน้อยแต่ได้มาก คือสุดยอดวิชา'*",
        'gloss_crypash_score': "Crypash Score: คะแนนคุณภาพเหรียญ (0-100)\n\n🐣 **ฉบับมือใหม่**: > 70 คืน **เกรด A** (พื้นฐานแน่น) น่าลงทุนยาว\n🧠 **มุมมองเซียน**: *'ราคาคือสิ่งที่คุณจ่าย มูลค่าคือสิ่งที่คุณได้' - Ben Graham*",
        'gloss_cycle': "Cycle Risk: ความเสี่ยงวัฏจักร\n\n🐣 **ฉบับมือใหม่**: \n- < 20% = **ต้นน้ำ** (ปลอดภัย)\n- > 80% = **ปลายน้ำ** (อันตราย)\n\n🧠 **มุมมองเซียน**: *'ตลาดเกิดจากความกังวล และตายด้วยความโลภ'*",
...
def page_howto():
    ...
    HOWTO_DATA = {
        'Intro': {
            'EN': """
            **Hello Crypash (Beta)!**  
            This tool combines **On-Chain Data** and **Cycle Theory** to find high-probability setups.
            We focus on *Value* (what it's worth) and *Momentum* (where it's going).
            """,
            'TH': """
            **ยินดีต้อนรับสู่ Crypash (เบต้า)!**  
            เครื่องมือคัดกรองคริปโตที่ไม่ได้ดูแค่กราฟ แต่ใช้ **ข้อมูล On-Chain (ธุรกรรมบนบล็อกเชน)** และ **Cycle Theory (วัฏจักรตลาด)** เพื่อหาเหรียญต้นน้ำและจุดเข้าซื้อที่ได้เปรียบ
            """
        },
        'Step1': {
            'EN': {
                'title': "1. Key Metrics Explained (The Guru's Guide)",
                'desc': """
                ### 🐋 MVRV Z-Score (The Valuation Gauge)
                - **Concept**: Compares Market Price vs Realized Price (Average Cost Basis).
                - **🐣 Beginner**: If Z-Score < 0, it's a "Fire Sale". If > 3.5, it's a "Bubble".
                - **🧠 Guru Wisdom**: *"The best time to buy is when there is blood in the streets."* (Low MVRV identifies this 'blood').

                ### ⚡ RSI (The Momentum Gauge)
                - **Concept**: Measures the speed of price changes.
                - **🐣 Beginner**: Low RSI (<30) = Oversold (Bounce likely). High RSI (>70) = Overbought (Correction likely).
                - **🧠 Guru Wisdom**: *"Be fearful when others are greedy, and greedy when others are fearful."*

                ### � Crypash Score
                - **Concept**: 0-100 Quality Rating based on Revenue, Tech, and Tokenomics.
                - **🐣 Beginner**: Think of it as a Credit Score. > 70 is excellent.
                """
            },
            'TH': {
                'title': "1. รู้จักตัวเลขสำคัญ (ฉบับเข้าใจง่าย & มุมมองเซียน)",
                'desc': """
                ### 🐋 MVRV Z-Score (ดัชนีวัด "ของถูก vs ของแพง")
                - **คืออะไร**: การเทียบราคาตลาด (Market Price) กับต้นทุนเฉลี่ยของคนทั้งโลก (Realized Price)
                - **🐣 ฉบับมือใหม่**: 
                   - **โซนสีเขียว (< 0)**: แปลว่า **"ของถูกมาก"** (Undervalued) ราคาต่ำกว่าทุนเจ้ามือ เป็นจุดเข้าซื้อที่ดีที่สุด
                   - **โซนสีแดง (> 3.5)**: แปลว่า **"ฟองสบู่"** (Overvalued) คนกำไรกันเยอะแล้ว ระวังแรงเทขาย
                - **🧠 มุมมองเซียน**: *"จงกล้าเมื่อคนอื่นกลัว"* (ค่า MVRV ต่ำๆ คือช่วงที่คนกลัวที่สุด และเป็นโอกาสที่ดีที่สุด)

                ### ⚡ RSI (ดัชนีวัด "แรงซื้อ vs แรงขาย")
                - **คืออะไร**: ตัวบอกว่าราคาวิ่งแรงเกินไปหรือยัง?
                - **🐣 ฉบับมือใหม่**: 
                   - **ต่ำกว่า 30**: ขายกันเยอะเกินไปแล้ว (Oversold) ราคามีโอกาสเด้งกลับ
                   - **สูงกว่า 70**: ซื้อกันเยอะเกินไปแล้ว (Overbought) ราคามีโอกาสย่อตัว
                - **🧠 มุมมองเซียน**: *"อย่ารับมีดตอนที่มันร่วงแรงๆ รอกราฟเริ่มงัดหัวขึ้น (RSI ยกตัว) ค่อยเข้าซื้อ"*

                ### � Crypash Score (คะแนนคุณภาพเหรียญ)
                - **คืออะไร**: คะแนนเต็ม 100 ที่ AI คำนวณจาก พื้นฐาน (รายได้) + การใช้งาน (Network) + ความเสี่ยง
                - **🐣 ฉบับมือใหม่**: 
                   - **> 70**: **เกรด A** (พื้นฐานแน่น, รายได้ดี, มีคนใช้จริง)
                   - **< 40**: **เกรด F** (เหรียญปั่น, ไม่มีการใช้งานจริง)
                - **🧠 มุมมองเซียน**: *"ราคาคือสิ่งที่คุณจ่าย มูลค่าคือสิ่งที่คุณได้" (Price is what you pay. Value is what you get.)*
                """
            }
        },
        'Step2': {
            'EN': {
                'title': "2. How to Scan",
                'desc': """
                1. **Choose a Universe**: 'Top 200' is best for general scanning.
                2. **Apply Filters**: 
                   - Want Safe? Set **MVRV Max** to 1.0.
                   - Want Growth? Set **Vol Growth** to > 20%.
                3. **Execute**: The engine will score every coin. Look for the 'Perfect Match' badge.
                """
            },
            'TH': {
                'title': "2. วิธีสแกนหา 'เพชรในตม' (Scanner)",
                'desc': """
                1. **เลือกสนามล่า (Universe)**: แนะนำ **'All (Top 200)'** เพื่อโอกาสเจอเหรียญดีๆ ที่คนยังไม่เห็น
                2. **ตั้งตะแกรงร่อน (Filters)**:
                   - สายปลอดภัย: ตั้ง **MVRV Max = 1.0** (หาเหรียญราคาไม่แพง)
                   - สายซิ่ง: ตั้ง **Vol Growth > 20%** (หาเหรียญที่คนเริ่มมารุมซื้อ)
                3. **กดปุ่ม Execute**: ระบบจะให้คะแนนและเรียงลำดับมาให้ เลือกดูตัวที่ได้ **Crypash Score สูงๆ**
                """
            }
        },
        'Step3': {
            'EN': {
                'title': "3. Deep Dive & Portfolio",
                'desc': """
                - **Deep Dive**: Check the 'Cycle Risk' gauge. If it's > 80%, consider taking profit.
                - **Auto-Wealth**: Use our MPT Algorithm to balance your portfolio size.
                """
            },
            'TH': {
                'title': "3. เจาะลึก & จัดพอร์ต (Deep Dive & Portfolio)",
                'desc': """
                - **Deep Dive (เจาะลึก)**: พิมพ์ชื่อเหรียญเพื่อดู **Cycle Risk (เข็มวัดความเสี่ยง)** 
                   - ถ้าเข็มชี้ไปทาง **แดง (> 80%)**: **"เซียนบอกว่าให้ทยอยขาย"**
                   - ถ้าเข็มชี้ไปทาง **เขียว (< 20%)**: **"เซียนบอกว่าให้ทยอยสะสม"**
                - **Auto-Wealth (จัดพอร์ต)**: ให้ AI คำนวณสัดส่วนการลงทุนที่เหมาะสมกับความเสี่ยงของคุณ (ไม่ต้องเดาเอง)
                """
            }
        },
        'Step4': {
            'EN': {
                'title': "4. Reference Data",
                'desc': """
            ...
            'TH': {
                'title': "4. ตารางสรุปเกณฑ์ (Reference Table)",
                'desc': """
                | ตัวชี้วัด (Metric) | โซนปลอดภัย (ซื้อ) | โซนอันตราย (ขาย) | ความหมาย |
                | :--- | :--- | :--- | :--- |
                | **MVRV Z-Score** | < 0.0 (ของถูก) | > 3.5 (ฟองสบู่) | ดูความถูกแพงพื้นฐาน |
                | **RSI** | < 30 (ขายมากไป) | > 70 (ซื้อมากไป) | ดูจังหวะเข้าออกระยะสั้น |
                | **Volatility** | < 60% (นิ่ง) | > 120% (ผันผวน) | ดูความเสี่ยงราคาเหวี่ยง |
                """
            }
        }
    }
