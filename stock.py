...
TRANS = {
    'EN': {
        ...
        'feat_qai': "**2. AI Analyst**: Let AI (Gemini) read the financial reports and news for you to give a deep qualitative grading.",
        ...
        'feat_qhealth': "**Health Check (Doctor)**: Perform a regular check-up on your portfolio health (Coming Soon).",
        ...
        'port_title': "Portfolio Architect",
        ...
        # --- AIFOLIO KEYS ---
        'aifolio_title': "Portfolio Architect",
    ...
    'TH': {
        ...
        'feat_qai': "**2. AI Analyst**: ให้ AI (Gemini) อ่านงบการเงินและข่าวแทนคุณ พร้อมให้เกรดและบทวิเคราะห์เชิงคุณภาพ",
        ...
        'feat_qwealth': "**Portfolio Architect**: ออกแบบพอร์ตโฟลิโอส่วนตัวตามเป้าหมายชีวิตของคุณด้วยสมองกล AI",
        'feat_qhealth': "**Health Check (Doctor)**: ตรวจสุขภาพพอร์ตโฟลิโอหาความเสี่ยงและจุดบกพร่อง (พบกันเร็วๆ นี้)",
