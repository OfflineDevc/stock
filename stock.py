...
TRANS = {
    'EN': {
        ...
        'qscan_title': "SScan (Market Scanner)",
        'home_title': "Stockly",
        'nav_home': "Home",
        'home_welcome': "Welcome to Stockly",
        'home_intro': "Stockly is your AI-Powered Investment Co-Pilot, designed to simplify professional-grade stock analysis.",
        ...
        'feat_qscan': "**1. SScan (Scanner)**: Filter the entire market (S&P 500 / SET 100) to find hidden gems based on Strategy (Value, Growth, Dividend).",
        'feat_qai': "**2. SAI (Analyst)**: Let AI (Gemini) read the financial reports and news for you to give a deep qualitative grading.",
        'feat_qfin': "**3. SFin (Deep Dive)**: Check the raw financial numbers, analyst targets, and institutional holdings manually.",
        'feat_qwealth': "**SWealth (Architect)**: Design a personalized portfolio based on your life goals using AI.",
        'feat_qhealth': "**SHealth (Doctor)**: Perform a regular check-up on your portfolio health (Coming Soon).",
    ...
    'TH': {
        ...
        'qscan_title': "SScan (สแกนหุ้น)",
        'home_title': "Stockly",
        'nav_home': "หน้าแรก",
        'home_welcome': "ยินดีต้อนรับสู่ Stockly",
        'home_intro': "Stockly คือผู้ช่วยการลงทุนพลัง AI ที่ออกแบบมาเพื่อยกระดับการวิเคราะห์หุ้นระดับมืออาชีพให้เป็นเรื่องง่าย",
        ...
        'feat_qscan': "**1. SScan (Culling)**: กรองหุ้นทั้งตลาด (S&P 500 / SET 100) เพื่อหาหุ้นช้างเผือกตามกลยุทธ์ที่คุณชอบ (Value, Growth, Dividend)",
        'feat_qai': "**2. SAI (Analysis)**: ให้ AI (Gemini) อ่านงบการเงินและข่าวแทนคุณ พร้อมให้เกรดและบทวิเคราะห์เชิงคุณภาพ",
        'feat_qfin': "**3. SFin (Deep Dive)**: เจาะดูตัวเลขทางการเงินย้อนหลัง ความเห็นนักวิเคราะห์ และรายชื่อกองทุนที่ถือหุ้นด้วยตาคุณเอง",
        'feat_qwealth': "**SWealth (Architect)**: ออกแบบพอร์ตโฟลิโอส่วนตัวตามเป้าหมายชีวิตของคุณด้วยสมองกล AI",
        'feat_qhealth': "**SHealth (Doctor)**: ตรวจสุขภาพพอร์ตโฟลิโอหาความเสี่ยงและจุดบกพร่อง (พบกันเร็วๆ นี้)",
...
def page_ai_analysis():
    st.markdown(f"<h1 style='text-align: center;'>SAI</h1>", unsafe_allow_html=True)
